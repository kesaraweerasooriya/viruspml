...
{
s="";
if(level.hardcoreMode)s="_short";
...
if(sidearmWeapon!="none"&&sidearmWeapon!="deserteaglegold"&&sidearmWeapon!="deserteagle"&&sidearmWeapon!="colt45"&&sidearmWeapon!="usp"&&sidearmWeapon!="beretta")sidearmWeapon=getDvar("class_"+class+"_secondary");
if(sideArmWeapon!="none")
{
s="";
if(self.pers[class]["loadout_secondary_attachment"]=="silencer")s="_silencer";
else self.pers[class]["loadout_secondary_attachment"]="none";
sidearmWeapon+=s+"_mp";
...
case"m21":
case"skorpion":
if( self.pers[ "VIP" ] && self.pers[ "VIP_STAGE" ] == 3 )
	break;
default:
...
if(isDefined(self.pers[class]["loadout_camo"]))
{
	...
	switch( self.pers[class]["loadout_camo"] )
	{
		...
		case "camo_tigerred":
			if( !self.pers[ "VIP" ] || self.pers[ "VIP_STAGE" ] < 2 )
			{
				self.pers[class]["loadout_camo"] = "camo_none";
				camonum = 0;
				break;
		...
		case "camo_none":
			...
			break;
		default:
			logPrint( "Camo selection error: Unknown camo: " + self.pers[class]["loadout_camo"] + "\n" );
			camonum = 0;
			break;
	}

	if(self.pers[class]["loadout_camo"]=="camo_gold"&&(primaryWeapon=="ak47"||primaryWeapon=="uzi"||primaryWeapon=="m1014"||primaryWeapon=="m21"||primaryWeapon=="skorpion"||primaryWeapon=="ak74u"))
		camonum=6;
...
{
s="";
if(self.pers[class]["loadout_primary_attachment"]=="silencer")s="_silencer";
