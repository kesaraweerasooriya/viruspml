...
main()
{
	...
	// website
	setDvar( "promod_hud_website", "^5WwW.^8ViRuSGaminG^5.xYz" ); // (avoid "//" here)
	...
	setDvar( "promod_mc_loopdelay", 17 ); // [1->] (delay in seconds until it starting over)
	setDvar( "promod_mc_maxmessages", 25 ); // [1->] (set this equivalent to number of messages)
	setDvar( "promod_mc_message_1", "^5Welcome to ^7ViRuS GaminG ^5SnD Server" );
	setDvar( "promod_mc_message_2", "^5Thank you for playing ^7in our server" );
	setDvar( "promod_mc_message_3", "^5Hacking Will lead ^7to Permanent Ban!" );
